...
simpson_indices <- apply(community_matrix, 2, function(x) diversity(x, index = "simpson"))

# Add richness
species_richness <- colSums(community_matrix > 0)

# Create summary table
diversity_summary <- data.frame(
  Site = colnames(community_matrix),
